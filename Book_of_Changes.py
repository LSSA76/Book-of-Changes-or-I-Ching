...
book_of_changes = {'1': ["""
    ...
    sake of prestige. It is enough if the work is done: let the honor go to the other.
    ...
    The justifying cause of a war, and clear and intelligible war aims, ought to
    be explained to the people by an experienced leader. Unless there is a quite
    definite war aim to which the people can consciously pledge themselves, the
    unity and strength of conviction that lead to victory will not be forthcoming.
    But the leader must also look to it that the passion of war and the delirium of
    victory do not give rise to unjust acts that will not meet with general approval.
    ...
    """,
        ...
        x Six in the fourth place means:
    ...
    """,
        ...
        x Six in the third place means:
    ...
    disposed towards the highly placed. There is an end to all feuds.
    ...
    public life, fruitful activity is rendered impossible, because the foundations
    ...
    the responsibility they have taken upon themselves. In their hearts they
    begin to be ashamed, although at first they do not show it outwardly.
    ...
    """,
        ...
        o Nine in the third place means:
    ...
    """,
        ...
        o Nine in the fourth place means:
    ...
    with debasing attitudes and fashions; they corrupt human society. To do away
    with corruption, the superior man must regenerate society. His methods likewise
    must be derived from the two trigrams, but in such a way that their effects
    unfold in orderly sequence. The superior must first remove stagnation by
    stirring up public opinion, as the wind stirs up everything, and must
    strengthen and tranquilize the character of the people, as the mountain
    ...
    """,
        ...
        o Nine at the top means:
    
        Contemplation of his life.
        The superior man is without blame.
    
    A man in an authoritative position to whom others look up must always be ready
    for self-examination. The right sort of self-examination, however, consists not
    in idle brooding over oneself but in examining the effects one produces. Only
    when these effects are good, and when one's influence on others is good, will the
    contemplation of one's own life bring the satisfaction of knowing oneself to be
    free of mistakes. 
    ...
    the earth broad and great, not proud and steep. So likewise those who ride
    ...
    something wrong he should make a noble-hearted resolve to confess his fault.
    ...
    Ch'ien, heaven is above; Chen, movement, is below. The lower trigram
    ...
    The Creative is tamed by Ken, Keeping Still. This produces great power, a
    ...
    obstacle. He sees himself held back firmly. If he should attempt to force an
    ...
    OF THE SMALL (9). However, in the later the restraining force is slight; thus
    a conflict arises between the propulsive and the restraining movement, as a
    ...
    forehead, so that later when the horns appear they cannot do hann. A good
    ...
    """,
        ...
        And look at me with the comers of your mouth drooping.
        Misfortune.
    ...
    This means an extraordinary reanimation of the processes of growth. In the same
    way, an extraordinary situation arises when an older man marries a young girl
    who suits him. Despite the unusualness of the situation, all goes well. From
    the point of view of politics, the meaning is that in exceptional times one
    does well to join with the lowly, for this affords a possibility of renewal.
    ...
    body, the principle of light in-closed in the dark - that is, reason. The name of
    ...
    and un-free, and when man recognizes this limitation and makes himself
    ...
    """,
        ...
        x Six in the fifth place means:
    ...
    If it is one's won horse, one can safely let it go; it will come back of its own
    ...
    If the water in the lake gathers until it rises above the earth, there is danger
    of a break-through. Precautions must be taken to prevent this. Similarly where
    ...
    Human woes usually come as a result of unexpected events against which we are
    not forearmed. If we are prepared, they can be prevented.
    ...
    leaping over nothing, leads to the goal.
    ...
    True, if a well is being lined with stone, it cannot be used while the work is
    ...
    forces of darkness, eventuating in the revolution of the seasons. Man masters
    these changes in nature by noting their regularity and marking off the passage
    of time accordingly. In this way order and clarity appear in the apparently
    chaotic changes of the seasons, and man is able to adjust himself in advance
    to the demands of the different times.
    ...
    A tiger skin, with its highly visible black stripes on a yellow ground, shows its
    ...
    Chen is movement; Li is flame, whose attribute is clarity. Clarity within,
    ...
    the mountain, Ken, stands still; above it fire, Li, flames up and does not tarry.
    ...
    Inborn gentleness is often carried to the point of indecisiveness. One does
    ...
    slink into dark comers and from this hiding affect people by suggestion. In
    ...
    influences into the most secret comers. But he no longer has the strength to
    ...
    """,
        ...
        x Nine in the second place means:
    ...
    one's own person and exert their influence on men. Deeds are bom close at
    hand and become visible far away. Words and deeds are the hinge and
    bow spring of the superior man. As hinge and bow spring move, they bring
    ...
    the strong lines preponderate and are within, in-closed between weak lines at the
    ...
    no rain. Similarly, in exceptional times there may be a bom ruler who is
    ...
    The lines "Illustrious Ancestor" is the dynastic title of the Emperor Wu Ting
    of the Yin dynasty. After putting his realm in order with a strong hand, he waged
    long colonial wars for the subjection of the Huns who occupied the northern
    ...
    another have made themselves impossible at home, but who are thought to
    ...
    """],
                   'Index': ["""    The Book of Changes

    1. The Creative\t\t\t\t\t--\t777777
    2. The Receptive\t\t\t\t\t--\t888888
    3. Difficulty at the Beginning\t\t\t\t\t--\t788878
    4. Youthful Folly\t\t\t\t\t--\t878887
    5. Waiting [Nourishment]\t\t\t\t\t--\t777878
    6. Conflict\t\t\t\t\t--\t878777
    7. The Army\t\t\t\t\t--\t878888
    8. Holding Together [Union]\t\t\t\t\t--\t888878
    9. The Taming Power of the Small\t\t\t\t\t--\t777877
    10. Treading [Conduct]\t\t\t\t\t--\t778777
    11. Peace\t\t\t\t\t--\t777888
    12. Standstill [Stagnation]\t\t\t\t\t--\t888777
    13. Fellowship with Men\t\t\t\t\t--\t787777 
    14. Possession in Great Measure\t\t\t\t\t--\t777787
    15. Modesty\t\t\t\t\t--\t887888
    16. Enthusiasm\t\t\t\t\t--\t888788
    17. Following\t\t\t\t\t--\t788778
    ...
    24. Return [The Turning Point]\t\t\t\t\t--\t788888
    25. Innocence [The Unexpected]\t\t\t\t\t--\t788777
    26. The Taming Power of the Great\t\t\t\t\t--\t777887
    ...
    32. Duration\t\t\t\t\t--\t877788
    33. Retreat\t\t\t\t\t--\t887777
    34. The Power of the Great\t\t\t\t\t--\t777788
    35. Progress\t\t\t\t\t--\t888787
    36. Darkening of the light\t\t\t\t\t--\t787888
    37. The Family [The Clan]\t\t\t\t\t--\t787877 
    38. Opposition\t\t\t\t\t--\t778787
    39. Obstruction\t\t\t\t\t--\t887878
    40. Deliverance\t\t\t\t\t--\t878788
    41. Decrease\t\t\t\t\t--\t778887
    42. Increase\t\t\t\t\t--\t788877
    43. Break-through [Resoluteness]\t\t\t\t\t--\t777778
    44. Coming to Meet\t\t\t\t\t--\t877777
    45. Gathering Together [Massing]\t\t\t\t\t--\t888778
    46. Pushing Upward\t\t\t\t\t--\t877888
    47. Oppression [Exhaustion]\t\t\t\t\t--\t878778
    48. The Well\t\t\t\t\t--\t877878
    49. Revolution (Molting)\t\t\t\t\t--\t787778
    50. The Caldron\t\t\t\t\t--\t877787
    51. The Arousing [Shock]\t\t\t\t\t--\t788788
    52. Keeping Still, Mountain\t\t\t\t\t--\t887887
    53. Development [Gradual Progress]\t\t\t\t\t--\t887877
    54. The Marrying Maiden\t\t\t\t\t--\t778788
    55. Abundance [Fullness]\t\t\t\t\t--\t787788
    56. The Wanderer\t\t\t\t\t--\t887787
    57. The Gentle [The Penetrating]\t\t\t\t\t--\t877877
    58. The Joyous\t\t\t\t\t--\t778778
    59. Dispersion [Dissolution]\t\t\t\t\t--\t878877
    60. Limitation\t\t\t\t\t--\t778878
    61. Inner Truth\t\t\t\t\t--\t778877
    62. Preponderance of the Small\t\t\t\t\t--\t887788
    63. After Completion\t\t\t\t\t--\t787878
    64. Before Completion\t\t\t\t\t--\t878787
"""],
                   'Info': ["""About the Book of Changes:

For the Western mind, steeped in the concept of causality, The Book of Changes, or
I Ching, undoubtedly presents a very foreign idea - the idea of finding meaning in
the seemingly meaningless, i.e chance. I will not in this short explanation on how this
book is constructed and how to use it, venture into deep philosophical discussions
about causality versus finding meaning in chance. If you need more information about
these subject I highly recommend buying a copy of 'I Ching or Book of Changes. The
Richard Wilhelm Translation 1950'. Which also is the translation used for this
program, and is in my opinion the best translation on the market. The Richard
Wilhelm version consist of three books, together with additional material. The
first book called: 'Book I: The Text', consist of the 64 hexagrams, the second book
called: 'Book II: The Material', consist of the philosophical explanation behind the
text, discussions regrading the lines and hexagrams, and the history of the book, and
much more. the third book: 'Book III: The Commentaries' is additional comments to
each of the 64 hexagrams in book one.

Only 'Book I: The Text' is included into this program. The reason for this is
simplicity and accessibility, and because book one is the main text (the beating heart)
of The Book of Changes. But what is The Book of Changes and the 64 hexagrams?

To put it in a nutshell The Book of Changes is an oracle book. You ask a question,
make a series of coin tosses, or dividing 49 yarrow stalks, and use the result from
these procedures to extract an answer from the book. I will not explain how to
perform these procedures because this is in essence what this piece of software will
do for you. (But you can find information about the coin toss method in the manuel
coin toss help window).

Each of the 64 hexagrams describes a typical situation, and is made up of The
Judgment, The Image and the six lines. The Judgment and The Image can be viewed
as the background setting or overall description of the situation. Alone The Judgment
and The Image is fairly vague and seldom give any specific insight into the question
asked. But background or context is essential to understand the big picture. The
really interesting parts are the lines. It is with the lines that you can get specific
information regarding your question. And because of that it is the lines that demands
the most attention.

You can also know something about the line based on its position in the hexagram.
The beginning line (line 1) is regarded as being before the actual situation, or a
precursor to what is about to happen. The top line (line 6) is regarded as being after
the situation, or on the borderline between this situation and the next. Line 2 and 3 is
low or earthly lines, 2 lower than 3. They very often describes everyday and practical
(favorable and unfavorable) situations. line 4 and 5 is high or heavenly lines, 5 higher
than 4. They describe more spiritual or philosophical aspects of the situation in
question. Sometimes you will find either an 'o' or 'x' in the heading of the line. These
marks denotes that the line is the ruler of the hexagram, and therefore of special
importance.

But what we have discussed is actually not 'the hexagram' but the contend of the
hexagram. Hex means six, and the actual hexagram is the symbolic representation
of the 64 different situations - each symbolized by six lines. These six lines is
called a hexagram each hexagram is made of two trigrams. A trigram consist of three
lines, and a line can either be unbroken (top) or broken (bottom).

                                                        _______________
                                                        ______       ______


The unbroken line is masculine - creative - strong, and is represented with the odd
values of 7 and 9. The broken line is feminine - receptive - yielding, and is represented
with the even values of 6 and 8. The value 6 and 9 are considered moving or changing
lines and plays a important part when extracting the answer. We will get back to that
later. There are in total eight trigram each with is own Name, Attribute, Image and
Family Relationship:
...
The Receptive, Devoted & Yielding, Earth, Mother:
                                                        ______       ______
                                                        ______       ______
                                                        ______       ______

The Arousing, Inciting Movement, Thunder, First Son:
                                                        ______       ______
                                                        ______       ______
                                                        _______________
...
The Gentle, Penetrating, Wind & Wood, First Daughter:
                                                        _______________
                                                        _______________
                                                        ______       ______
...
As mentioned a hexagram consist of two trigrams, an upper an lower. Which will
make 64 different hexagrams. The beginning line (or line 1) is perhaps contrary to 
what one would expect the bottom line. Let us look at an example, below is shown
hexagram 54. The Marrying Maiden. The upper trigram is The Arousing (the 3 top
lines), the lower trigram The Joyous (the 3 bottom lines):
...
The beginning line (the bottom one) is unbroken, the second line is unbroken etc., and
as we learned earlier unbroken lines have the odd values 7 and 9, and broken lines
have the even values 6 and 8. So another way to write 54. The Marrying Maiden
without any moving lines would look like this: 778788 - or comprised entirely of
moving lines: 996966. If you try to run the two series with the manuel method you will
see that both times 54. The Marrying Maiden is displayed, but the 778788 series
produces only that hexagram, whereas the  996966 series produces not only 54. The
Marrying Maiden and the six accompanying lines, but also 53. Development [Gradual
Progress]. The reason for that is because the moving (or changing) lines perform two
steps, the first step is to display the line text, the second step is to change into the
opposite of what is was. So when we ran the 996966 series it changed into 887877,
which is the mirror of 778788.

From this point forward we will use the number series to describe the hexagrams. If
you open the 'Book I: The Text' window you will find that to the right of every
hexagram a number series 'code' comprised of 7's and/or 8's is shown, and below the
index you will find the actual book from beginning to end. If you want to read one
...
Six years ago I read a book called 'Memories, Dreams, Reflections' by Carl G. Jung.
The book was an interesting read, but not nothing earth-shattering in itself. I had
a great deal of respect for Carl G. Jung and his work, especially his ideas regarding
dreams. But it was not dreams that caught my eye, but an appendix way back in the
book called 'Richard Wilhelm'. Having no idea who Richard Wilhelm was and what
Carl Jung's relationship was to him, I began to read. Jung wrote about the man, but
he also described a book called 'I Ching or The Book of Changes', a book I at that time
never had heard of, and how he had used this mysterious oracle book. My first impulse
was skepticism. I had never payed much attention to any form of divination or oracles.
I had much the same ideas as most people probably have regarding this topic, which
is that you see whatever you want in such answers.

But how could I justify a quick dismissal from a man I deeply admired, a man I
believed to be one of the greatest minds of our age? So I bought a copy of
Richard Wilhelm's translation and began to read. My initial impression was that it
seemed very esoteric, but when I understood the mechanics of the oracle process I
found three coins, sat down and asked my first question. And to my surprise the
answer I got made perfect sense. But it could have been a fluke, so I asked another,
and another... and lo and behold every answer made sense. But not only that, specific 
keywords and phrases in my questions were to be found in the answer. I used to be an
ardent poker player back in the day, I read many books about poker and probability
calculus. So I believed I could spot what was likely, highly unlikely, highly improbable
and astronomical. The sheer odds were in the two last categories. That was my
analytical senses talking, but that was far from the loudest voice I heard. What shook
me to the core of my being was the ramifications of this discovery. The discovery that
life was more than just particles bumping together in a deterministic chaos. My sense
of reality had been turned upside down.

But what was I to do with this new knowledge. In my naivete I thought everybody
would see what I saw and be equally amazed. But to my surprise they were not the
tiniest bit amazed. Some were amused, most were indifferent and a few was directly
hostile to the idea. As time passed I became less and less vocal about The Book of
Changes. The most common response I received was 'So you do what the book tells you
to do?' often said in a poorly veiled tone of contempt. I never really knew how to
respond to that question. Partly because some of it rang true, but I knew that was
the wrong way to look at it. My answer today would be that I look at the book as a
trusted adviser, not a guide. The difference being that you are not obliged to follow an
adviser, whereas you are with a guide. But the greatest gift The Book of Changes
gives is not the advise or oracle, but the inspiration you receive to think about the
situation in question. The book points your mind in a general direction, but it is you
who will do the thinking - you will become a true actor in your own life. The book
does not put restraints on you to act in a certain way, but sets you free to act in
accordance with the will of heaven - If you so choose. Another common misconception
I heard was the before mentioned statement; that you read what you want to read.
That is certainly not my experience. The answers I've received is rarely the answers
I want, but the answers I need at that particular moment in time. Sometimes I needed
very little information, but wanted much - I got just enough. I know that now in
retrospect. The oracle reveals what is suitable for the situation - nothing more.  

Carl G. Jung wrote the foreword for the Richard Wilhelm translation, it is quite
long, but I urge anyone to read it. In it Carl G.Jung asks the book to describe itself
with the new translation in mind. He then proceeds to interpret the answer he got.
In the spirit of Carl G. Jung I will do the same in regard to this digital adaptation
of Richard Wilhelm's translation. I asked the following question and received the
answer found below (my comments and interpretations will be found in brackets): 

3. september 2019

Question: (The Book of Changes has hopefully been made more accessible and easier
to use with this new digital version). Before asking the first question, what should
a new user think of this version of the book?    

============================================================

        16. ENTHUSIASM
    
        above The Arousing, Thunder     (Upper trigram)
        below The Receptive, Earth      (Lower trigram)
...
(Here we can already get a sense of what is to be expected, namely that there is
movement above and receptive devotion below which will leads to enthusiasm.)
...
(As I have personified The Book of Changes we can read the answer as the book
in this case being the eminent man looking for helpers to lead, but the book can
only do so because it is in sympathy with the spirit of the people and acts
in accord with it. It is an invitation to those who wish wholeheartedly to partake.)
...
(The Image describes the spiritual and religious significance of using the book.
The Book of Changes was largely written by and to ancient kings in China many
centuries ago. Using it was a holy rite offered to the Supreme Deity - It should
still be viewed in that way.)
...
(In the second hexagram we are again cautiously warned against overreaching. Just
like Icarus we should not try to fly too close to the sun, or disaster will follow.
If we remain content with our earthly existence it will lead to great fortune. The
book is represented as the little bird bringing the message. Look for advise from
high places is good, but we should not loose our connection with worldly affairs)

============================================================

This was my interpretation of the answer, maybe you did not see the connections
between the question and the answer as I did, maybe you saw nuances and clues I
missed? It is a most peculiar book and it reveals itself differently to every reader.
Whatever one may think and feel about this book, the thought process made to
discern meaning from the answer is interesting and educational - at the very least
one learns something about oneself, and how can that be a mistake? I will use the
closing paragraph of Carl G. Jung's foreword in Richard Wilhelm's translation to
end my own:   

"It would seem to me that on the basis of this example an unprejudiced reader would
now be in a position to form at least a tentative judgment on the operation of the
I Ching. More cannot be expected from a simple introduction. If by means of this
demonstration I have succeeded in elucidating the psychological phenomenology of
the I Ching, I shall have carried out my purpose. As to the thousands of questions,
doubts, and criticisms that this singular book stirs up - I cannot answer these. The
I Ching does not offer itself with proofs and results; it does not vaunt itself, nor is
it easy to approach. Like a part of nature, it waits until it is discovered. It offers
neither facts nor power, but for lovers of self-knowledge, of wisdom - if there be such
- it seems to be the right book. To one person its spirit appears as clear as day; to
another, shadowy as twilight; to a third, dark as night. He who is not pleased by it
does not have to use it, and he who is against it is not obliged to find it true. Let
it go forth into the world for the benefit of those who can discern its meaning"

 - Lars Storm Andersen, September 2019."""],
                   'Question': ["""Question Help Window:

Asking the right question and formulating it in a correct way is of the greatest
importance and should not be done without serious deliberation. A poorly formulated
question will create a situation where interpreting the answer becomes very hard,
if not impossible.

So it is good practice to follow certain ground rules to make it easier for yourself.
First of all always try to ask open questions, you could begin your question like this:

    - 'How should I handle...',
    - 'What can I expect...',
    - 'In what way should I act, or view, or understand...', etc.

Avoid yes and no questions, or assuming some outcome as a given and then
ask how to proceed from there. Also try to be concise, long and convoluted questions
makes interpretations near impossible.  

Another way to help yourself is to describe the situation and the thoughts you have
about it as a reference text inside brackets, but without framing it as a question.
Then you can then ask a short question in reference to that text. That will help you
greatly when you come back to the answer weeks or months later with perhaps a very
different mindset about the situation in question.

Ethical rules when using The Book of Changes:

    - Never ask a question more than once. (See 4. Youthful Folly)
    - Don't ask about others personal affairs. (See 52. Keeping Still)
    - Don't use it with selfish and ulterior motives (See 29. The Abysmal).
    - Set limitations for yourself. (See 60. Limitation)


Note: You can of cause write your question in whatever language you please,
but the answer will be in displayed in english."""],
                   'Manuel': ["""Coin Toss Help Window:

The manuel coin toss feature is added for two reasons. The first reason is to
accommodate the wish for a more 'hands on' approach when processing the answer
from The Book of Changes. And the manuel method of using three actual coins when
asking a question may feel more authentic and perhaps more trustworthy for some
users. The second reason is of a more practical nature. Sometimes it might be of
interest to look up certain hexagrams or lines in a quick an easy way; the manuel coin
toss function will provide for that possibility.

In order to process an answer you need 3 coins:

The 'heads side' has a value of 3, and the tail side has a value of 2. When the three
coin are tossed four possible outcome can occur:

    - 3 tails: Giving the total value 6 (2+2+2).
    - 1 head and 2 tails: Giving the total value 7 (3+2+2).
    - 2 heads and 1 tail: Giving the total value 8 (3+3+2).
    - 3 heads: Giving the total value 9 (3+3+3).

This coin toss process is repeated six times in total, giving you six values ranging
between 6 and 9. The 7 and 8 values are considered fixed, whereas the values 6 (3 tails)
and 9 (3 heads) are considered moving or changing. When 6 and 9 are tossed you
receive an accompanying line in that position the value is in the six numbered series. 

As an example it could end up like this: 868798, giving you two moving lines in
position 2 and 5.

If you want to try out the example write 'test' or leave the name and question boxes
blank. Then set the 'Choose Method' to 'Manuel'. Insert the six values into the six
'Manuel Coin Toss' spinboxes, (line 1 - 8), (line 2 - 6), (line 3 - 8), etc.
Lastly press the 'Ask' button and the following answer will be shown:
...
The automatic coin toss method is constructed in an identical way. Three 'random'
values between 2 and 3 is generated and added together - again producing a 6, 7, 8 or
9. The process is repeated six times in total, resulting in the six numbered series 
needed to get an answer. 

For further information About The Book:

    - The different hexagrams.
    - How The Book of Changes is constructed.
...
very easy and is only needed the first time you run the program. The active path
feature enables you to save your questions and answers in a text document for future
readings, which is an essential part of using The Book of Changes correctly. All you
have to do is to create a folder (or use an existing one) where you want the Q&A text
documents to be stored. Then copy the path (CTRL + C) to that folder and paste it
(CTRL + V) into the 'Insert new active path' slot and press save.

example:

    Step 1 - create a folder on your desktop called Q&A.
    Step 2 - find the path to Q&A with pathfinder (for Windows).
    Step 3 - copy the path (CTRL + C).
    Step 4 - paste the path into 'Insert new active path' (CTRL + V).
    Step 5 - press the save button.

Your new active path will appear just below in the 'Active Path' frame. Run a test
with name and question boxes blank to check whether it works. If it does, you have
then successfully completed the set up. The active path will be remembered and used
every time you run the program.

When the active path is correctly saved, you will every time you ask a question save
the answer as a txt file. The file will look like this: (16-[3]-62)--03-09-19 0624.txt.
The different numbers tells you what's in the file and when the question was asked. The
brackets (16-[3]-62) contains in this case three numbers. The first one '16' tells
that the first hexagram is 16. Enthusiasm, the second number '3' in the square brackets
...
def general_info():
    ...
    def foreword():
        ...
        foreword_window.place_slaves()
        foreword_window.resizable(width=False, height=False)
        foreword_frame = tk.Frame(master=foreword_window, width=800, height=600, bg=the_book_colour)
        foreword_frame.place(relx=0, rely=0)
        scroll_1 = tk.Scrollbar(foreword_frame)
        text_1 = tk.Text(foreword_frame, borderwidth=2, width=61, height=22, font='Georgia 14')
        scroll_1.place(relx=0.95, rely=0.03, height=510)
        text_1.place(relx=0.03, rely=0.03)
        scroll_1.config(command=text_1.yview)
        text_1.config(yscrollcommand=scroll_1.set)
        text_1.insert(tk.END, book_of_changes['Foreword'][0])
    ...
    def the_book():
        ...
        the_book_window.place_slaves()
        the_book_window.resizable(width=False, height=False)
        the_book_frame = tk.Frame(master=the_book_window, width=800, height=600, bg=the_book_colour)
        the_book_frame.place(relx=0, rely=0)
        scroll_1 = tk.Scrollbar(the_book_frame)
        text_1 = tk.Text(the_book_frame, borderwidth=2, width=61, height=22, font='Georgia 14')
        scroll_1.place(relx=0.95, rely=0.03, height=510)
        text_1.place(relx=0.03, rely=0.03)
        scroll_1.config(command=text_1.yview)
        text_1.config(yscrollcommand=scroll_1.set)
        text_1.insert(tk.END, book_of_changes['Index'][0] + the_boc)
        tkinter.Button(the_book_frame, text='Close Window', font='Georgia 10',
                       command=the_book_window.destroy).place(relx=0.835, rely=0.9)

    general_info_window = tk.Tk()
    general_info_window.title('About The Book of Changes')
    general_info_window.geometry('800x600+550+200')
    general_info_window.place_slaves()
    general_info_window.resizable(width=False, height=False)
    general_info_frame = tk.Frame(master=general_info_window, width=800, height=600, bg=the_book_colour)
    general_info_frame.place(relx=0, rely=0)
    scroll = tk.Scrollbar(general_info_frame)
    text = tk.Text(general_info_frame, borderwidth=2, width=61, height=22, font='Georgia 14')
    scroll.place(relx=0.95, rely=0.03, height=510)
    text.place(relx=0.03, rely=0.03)
    scroll.config(command=text.yview)
    text.config(yscrollcommand=scroll.set)
    text.insert(tk.END, book_of_changes['Info'][0])
    tkinter.Button(general_info_frame, text='Close Window', font='Georgia 10',
                   command=general_info_window.destroy).place(relx=0.835, rely=0.9)
    tkinter.Button(general_info_frame, text='Book I: The Text', font='Georgia 10',
                   command=the_book).place(relx=0.15, rely=0.9)
    tkinter.Button(general_info_frame, text='Foreword', font='Georgia 10',
                   command=foreword).place(relx=0.04, rely=0.9)
...
def question_help():
    ...
    question_help_window.place_slaves()
    question_help_window.resizable(width=False, height=False)
    question_help_frame = tk.Frame(master=question_help_window, width=650, height=400, bg=info_bg_colour)
    question_help_frame.place(relx=0, rely=0)
    scroll = tk.Scrollbar(question_help_frame)
    text = tk.Text(question_help_frame, borderwidth=2, width=65, height=17, font='Georgia 11')
    scroll.place(relx=0.945, rely=0.045, height=315)
    text.place(relx=0.035, rely=0.05)
    scroll.config(command=text.yview)
    text.config(yscrollcommand=scroll.set)
    text.insert(tk.END, book_of_changes['Question'][0])
    tkinter.Button(question_help_frame, text='Close Help', font='Georgia 8',
                   command=question_help_window.destroy).place(relx=0.86, rely=0.9)
...
def manuel_help():
    ...
    manuel_help_window.place_slaves()
    manuel_help_window.resizable(width=False, height=False)
    manuel_help_frame = tk.Frame(master=manuel_help_window, width=650, height=400, bg=info_bg_colour)
    manuel_help_frame.place(relx=0, rely=0)
    scroll = tk.Scrollbar(manuel_help_frame)
    text = tk.Text(manuel_help_frame, borderwidth=2, width=65, height=17, font='Georgia 11')
    scroll.place(relx=0.945, rely=0.045, height=315)
    text.place(relx=0.035, rely=0.05)
    scroll.config(command=text.yview)
    text.config(yscrollcommand=scroll.set)
    text.insert(tk.END, book_of_changes['Manuel'][0])
    tkinter.Button(manuel_help_frame, text='Close Help', font='Georgia 8',
...
def path_help():
    ...
    path_help_window.place_slaves()
    path_help_window.resizable(width=False, height=False)
    path_help_frame = tk.Frame(master=path_help_window, width=650, height=400, bg=info_bg_colour)
    path_help_frame.place(relx=0, rely=0)
    scroll = tk.Scrollbar(path_help_frame)
    text = tk.Text(path_help_frame, borderwidth=2, width=65, height=17, font='Georgia 11')
    scroll.place(relx=0.945, rely=0.045, height=315)
    text.place(relx=0.035, rely=0.05)
    scroll.config(command=text.yview)
    text.config(yscrollcommand=scroll.set)
    text.insert(tk.END, book_of_changes['Path'][0])
    tkinter.Button(path_help_frame, text='Close Help', font='Georgia 8',
                   command=path_help_window.destroy).place(relx=0.86, rely=0.9)
...
def input_data():
    ...
    local_date = time.strftime('%d-%m-%y', time.localtime())
    entry_data = f'{local_date}, {name} asked the question:\n\n{question}\n\n' + ('=' * 60)
...
def manuel_update():
    ...
    five = line_5.get()
    six = line_6.get()
    coin = one + two + three + four + five + six
...
def auto_manuel_choice():
    ...
    if auto_manuel.get() is 1:
        ...
        choice_frame_new = tkinter.LabelFrame(master=window_frame, font='Georgia 10', bg=auto_colour)
        choice_frame_new.place(relx=0.11, rely=0.435)

        auto.destroy()
        auto_new = tkinter.Radiobutton(choice_frame_new, text='Auto', font='Georgia', value=1, bg=auto_colour,
                                       cursor='hand2', activebackground=auto_colour, variable=auto_manuel,
                                       command=auto_manuel_choice)
        auto_new.grid(row=1, column=0, sticky='w', padx=5, pady=3)

        manuel.destroy()
        manuel_new = tkinter.Radiobutton(choice_frame_new, text='Manuel', font='Georgia', value=2, bg=auto_colour,
                                         cursor='hand2', activebackground=auto_colour, variable=auto_manuel,
                                         command=auto_manuel_choice)
        manuel_new.grid(row=2, column=0, sticky='w', padx=5, pady=3)

        execute.destroy()
        execute_new1 = tkinter.Button(master=window_frame, text='  Ask  ', border=3, height=2, bg=auto_colour,
                                      activebackground=save_bg_colour, cursor='hand2', font='Georgia 14', fg='white',
                                      command=ask_auto)
    ...
    # If switched to manuel - destroy current, rebuild new manuel settings
        ...
        choose_frame.destroy()
        choice_frame_new = tkinter.LabelFrame(master=window_frame, font='Georgia 10', bg=manuel_colour)
        choice_frame_new.place(relx=0.11, rely=0.435)

        auto.destroy()
        auto_new = tkinter.Radiobutton(choice_frame_new, text='Auto', font='Georgia', value=1, bg=manuel_colour,
                                       cursor='hand2', activebackground=manuel_colour, variable=auto_manuel,
                                       command=auto_manuel_choice)
        auto_new.grid(row=1, column=0, sticky='w', padx=5, pady=3)

        manuel.destroy()
        manuel_new = tkinter.Radiobutton(choice_frame_new, text='Manuel', font='Georgia', value=2, bg=manuel_colour,
                                         cursor='hand2', activebackground=manuel_colour, variable=auto_manuel,
                                         command=auto_manuel_choice)
        manuel_new.grid(row=2, column=0, sticky='w', padx=5, pady=3)

        execute.destroy()
        execute_new2 = tkinter.Button(master=window_frame, text='  Ask  ', border=3, height=2, bg=manuel_colour,
                                      activebackground=save_bg_colour, cursor='hand2', font='Georgia 14', fg='white',
                                      command=ask_manuel)
        execute_new2.place(relx=0.735, rely=0.79)
...
def file_error():
    ...
    invalid_window.place_slaves()
    invalid_window.resizable(width=False, height=False)
    invalid_frame = tk.Frame(master=invalid_window, width=450, height=300, bg=warning_colour)
    invalid_frame.place(relx=0, rely=0)
    tkinter.LabelFrame(invalid_frame, width=360, height=175, text='Warning: Active Path Error!',
                       font='Georgia 10 bold', fg=warning_text_colour, bg=warning_colour).place(relx=0.1, rely=0.1)
    tkinter.Label(invalid_frame, text="Unable to continue: Active Path Error!"
...
def search():
    ...
    search_text = (book_of_changes[search_key][0] + ('=' * 60) +
                   book_of_changes[search_key][1] + ('=' * 60) +
                   book_of_changes[search_key][2] + ('=' * 60) +
    ...
    def search_answer_read():
        ...
        search_window.place_slaves()
        search_window.resizable(width=False, height=False)
        search_frame = tk.Frame(master=search_window, width=800, height=600, bg=answer_colour)
        search_frame.place(relx=0, rely=0)
        scroll = tk.Scrollbar(search_frame)
        text_1 = tk.Text(search_frame, borderwidth=2, width=61, height=22, font='Georgia 14', wrap=tk.WORD)
        scroll.place(relx=0.95, rely=0.03, height=510)
        text_1.place(relx=0.03, rely=0.03)
        scroll.config(command=text_1.yview)
        text_1.config(yscrollcommand=scroll.set)
        text_1.insert(tk.END, search_text)
        tkinter.Button(search_frame, text='Close Window', font='Georgia 10',
                       command=search_window.destroy).place(relx=0.05, rely=0.9)
...
def ask_auto():
    ...
    def coin_toss():
        ...
        three times and then adding them together returning
        a 6, 7, 8 or 9
        :return: x (str)
        """
        x = 0
    ...
    def coin_str_maker():
        """
        Repeats the coin toss process 6 times and concatenates
        the individual strings into one six digit string.
        ex. '679878'
        :return: x_str (str)
        """
        coin_str = ''
    ...
    coin_str_auto = coin_str_maker()

    def coin_int():
        # Transform the coin string into a list of integers.
        coin_int_x = list()
        for number in coin_str_auto:
            if number in '6789':
                number = int(number)
                coin_int_x.append(number)

        return coin_int_x

    def hex_converter():
        """
        The first for loop checks whether the
        integers is even or odd. if even a 0 is appended to the first_hex
        list, if odd a 1 is appended.
        The second for loop changes any 6 to 1, any 7 to 1, any 8 to 0 and
        any 9 to 0, and appends the integers to the second_hex list.
        lastly the two lists is transformed back into strings, as is the
        original coin.
        :return: first_hex, second_hex (both str)
        """
        first_hex_temp = []
        second_hex_temp = []
        ...
        for i in coin_int():
            if i % 2 == 0:
                first_hex_temp.append(0)
            else:
                first_hex_temp.append(1)

        for i in coin_int():
            if i == 6:
                second_hex_temp.append(1)
            if i == 7:
                second_hex_temp.append(1)
            if i == 8:
    ...
    def hex_finder(hex_code):
        """
        hex_code :parameter
        All the 64 individual values of the hex codes is looped through
        and compared with the first and second hex string. If they match
        the corresponding key is returned.
        key :return:
        """
        for hexagram in hex_codes[1:]:
            for key, value in hexagram.items():
                if value == hex_code:
                    return key
    ...
    def hex_lines():
        """
        coin_int :parameter
        It looks for any six or nine in the list. if found; the lines list
        is appended with a number 1 through 6, indicating the line
        where the number was found.
        x_line :return  (list of integers, or empty)
        """
        x_line = []

        if coin_int[0] == 6 or coin_int[0] == 9:
            x_line.append(1)
        if coin_int[1] == 6 or coin_int[1] == 9:
            x_line.append(2)
        if coin_int[2] == 6 or coin_int[2] == 9:
            x_line.append(3)
        if coin_int[3] == 6 or coin_int[3] == 9:
            x_line.append(4)
        if coin_int[4] == 6 or coin_int[4] == 9:
            x_line.append(5)
        if coin_int[5] == 6 or coin_int[5] == 9:
            x_line.append(6)
    ...
    if len(changing_lines) > 0:
        ...
        if 2 in changing_lines:
            lines += book_of_changes[first_hex_key][2] + ('=' * 60)
        if 3 in changing_lines:
            lines += book_of_changes[first_hex_key][3] + ('=' * 60)
        if 4 in changing_lines:
            lines += book_of_changes[first_hex_key][4] + ('=' * 60)
        if 5 in changing_lines:
            lines += book_of_changes[first_hex_key][5] + ('=' * 60)
        if 6 in changing_lines:
            lines += book_of_changes[first_hex_key][6] + ('=' * 60)
        if coin_str_auto == '999999':
        ...
        def answer_read():
            ...
            def restart_quit():
                ...
                restart_quit_frame = tk.Frame(master=restart_quit_window, width=450, height=300,
                                              bg=restart_quit_colour)
                restart_quit_frame.place(relx=0, rely=0)
                tkinter.LabelFrame(restart_quit_frame, width=360, height=175, text='New Question or Quit?',
                                   font='Georgia 10', bg=restart_quit_colour).place(relx=0.1, rely=0.1)
                tkinter.Label(restart_quit_frame, text=f'Your last Q&A can be found at:'
                                                       f'\n\n{active_path}'
            ...
            answer_window = tk.Tk()
            answer_window.title('The Answer')
            answer_window.geometry('800x600+550+200')
            answer_window.place_slaves()
            answer_window.resizable(width=False, height=False)
            answer_frame = tk.Frame(master=answer_window, width=800, height=600, bg=answer_colour)
            answer_frame.place(relx=0, rely=0)
            scroll = tk.Scrollbar(answer_frame)
            text_1 = tk.Text(answer_frame, borderwidth=2, width=61, height=22, font='Georgia 14', wrap=tk.WORD)
            scroll.place(relx=0.95, rely=0.03, height=510)
            text_1.place(relx=0.03, rely=0.03)
            scroll.config(command=text_1.yview)
            text_1.config(yscrollcommand=scroll.set)
...
main_colour = '#ddd3bf'
auto_colour = '#be9dd2'
manuel_colour = '#e994dc'
warning_colour = '#d1c4c2'
warning_text_colour = 'red'
the_book_colour = '#aeb5ff'
info_colour = '#a9d1fa'
info_bg_colour = '#6a9aea'
save_colour = '#c9c9c9'
save_bg_colour = '#adef65'
answer_colour = '#9e96eb'
...
tkinter.Label(master=window_frame, text='Insert your name:', font='Georgia 10',
              bg=main_colour).place(relx=0.1, rely=0.035)
# Name Entry
...
tkinter.Label(master=window_frame, text='Insert your question:', font='Georgia 10',
              bg=main_colour).place(relx=0.1, rely=0.14)
# Question Entry
question_entry_scroll = tk.Scrollbar(window_frame)
question_entry = tk.Text(master=window_frame, width=47, height=5, borderwidth=4, font='Georgia 14', wrap=tk.WORD)
question_entry_scroll.place(relx=0.815, rely=0.175, height=125)
question_entry.place(relx=0.1, rely=0.175)
question_entry_scroll.config(command=question_entry.yview)
question_entry.config(yscrollcommand=question_entry_scroll.set)
...
tkinter.Label(master=window_frame, text='Choose Method', font='Georgia 10',
              bg=main_colour).place(relx=0.105, rely=0.4)
choose_frame = tkinter.LabelFrame(master=window_frame, font='Georgia 10', bg=auto_colour)
choose_frame.place(relx=0.11, rely=0.435)
# Choose Method Radiobutton
auto_manuel = tkinter.IntVar()
auto_manuel.set(1)
# Auto
auto = tkinter.Radiobutton(choose_frame, text='Auto', font='Georgia', value=1, bg=auto_colour, cursor='hand2',
                           variable=auto_manuel, activebackground=auto_colour, command=auto_manuel_choice)
auto.grid(row=1, column=0, sticky='w', padx=5, pady=3)
# Manuel
...
tkinter.Label(master=window_frame, text='Manuel Coin Toss', font='Georgia 10',
              bg=main_colour).place(relx=0.26, rely=0.4)
manuel_toss = tkinter.LabelFrame(master=window_frame, bg=manuel_colour)
manuel_toss.place(width=450, height=74, relx=0.26, rely=0.435)
# Coin Toss Spinbox 1
tkinter.Label(manuel_toss, text='Line 1', bg=manuel_colour, font='Times 10').place(relx=0.035, rely=0.1)
line_1 = StringVar()
line_1.set(7)
line_one = tkinter.Spinbox(manuel_toss, width=2, from_=6, to=9, font='Times 16', borderwidth=2, justify=CENTER,
                           textvariable=line_1, state=NORMAL, command=manuel_update)
line_one.place(relx=0.035, rely=0.4)
# Coin Toss Spinbox 2
tkinter.Label(manuel_toss, text='Line 2', bg=manuel_colour, font='Times 10').place(relx=0.200, rely=0.1)
line_2 = StringVar()
line_2.set(7)
line_two = tkinter.Spinbox(manuel_toss, width=2, from_=6, to=9, font='Times 16', borderwidth=2, justify=CENTER,
                           textvariable=line_2, state=NORMAL, command=manuel_update)
line_two.place(relx=0.200, rely=0.4)
# Coin Toss Spinbox 3
tkinter.Label(manuel_toss, text='Line 3', bg=manuel_colour, font='Times 10').place(relx=0.365, rely=0.1)
line_3 = StringVar()
line_3.set(7)
line_three = tkinter.Spinbox(manuel_toss, width=2, from_=6, to=9, font='Times 16', borderwidth=2, justify=CENTER,
                             textvariable=line_3, state=NORMAL, command=manuel_update)
line_three.place(relx=0.365, rely=0.4)
# Coin Toss Spinbox 4
tkinter.Label(manuel_toss, text='Line 4', bg=manuel_colour, font='Times 10').place(relx=0.535, rely=0.1)
line_4 = StringVar()
line_4.set(7)
line_four = tkinter.Spinbox(manuel_toss, width=2, from_=6, to=9, font='Times 16', borderwidth=2, justify=CENTER,
                            textvariable=line_4, state=NORMAL, command=manuel_update)
line_four.place(relx=0.535, rely=0.4)
# Coin Toss Spinbox 5
tkinter.Label(manuel_toss, text='Line 5', bg=manuel_colour, font='Times 10').place(relx=0.700, rely=0.1)
line_5 = StringVar()
line_5.set(7)
line_five = tkinter.Spinbox(manuel_toss, width=2, from_=6, to=9, font='Times 16', borderwidth=2, justify=CENTER,
                            textvariable=line_5, state=NORMAL, command=manuel_update)
line_five.place(relx=0.700, rely=0.4)
# Coin Toss Spinbox 6
tkinter.Label(manuel_toss, text='Line 6', bg=manuel_colour, font='Times 10').place(relx=0.865, rely=0.1)
line_6 = StringVar()
line_6.set(7)
line_six = tkinter.Spinbox(manuel_toss, width=2, from_=6, to=9, font='Times 16', borderwidth=2, justify=CENTER,
                           textvariable=line_6, state=NORMAL, command=manuel_update)
line_six.place(relx=0.865, rely=0.4)
# Manuel Help Button
question_logo_2 = PhotoImage(file='Inventory/question12_2.png')
...
search_function_frame = tkinter.LabelFrame(master=window_frame, font='Georgia 10', bg=info_colour)
search_function_frame.place(relx=0.11, rely=0.610, width=570, height=50)
# Search Button
tkinter.Button(master=search_function_frame, text='Show', border=3, cursor='hand2', font='Georgia 8 bold',
               bg=save_colour, activebackground=save_bg_colour,
               command=search).place(relx=0.8, rely=0.2)
# Search Combobox
combo_hex = tk.StringVar()
hex_combo = ttk.Combobox(search_function_frame, font='Georgia 12', textvariable=combo_hex)
hex_combo.place(relx=0.1, rely=0.21, width=380, height=25)
hex_combo['values'] = ('1. The Creative', '2. The Receptive', '3. Difficulty at the Beginning',
                       '4. Youthful Folly', '5. Waiting [Nourishment]', '6. Conflict',
                       '7. The Army', '8. Holding Together [Union]', '9. The Taming Power of the Small',
                       '10. Treading [Conduct]', '11. Peace', '12. Standstill [Stagnation]',
                       '13. Fellowship with Men', '14. Possession in Great Measure', '15. Modesty',
                       '16. Enthusiasm', '17. Following', '18. Work on what has been spoiled [Decay]',
                       '19. Approach', '20. Contemplation [View]', '21. Biting Through',
                       ...
                       '43. Break-through [Resoluteness]', '44. Coming to Meet', '45. Gathering Together [Massing]',
                       '46. Pushing Upward', '47. Oppression [Exhaustion]', '48. The Well',
                       '49. Revolution [Molting]', '50. The Caldron', '51. The Arousing [Shock]',
                       '52. Keeping Still', '53. Development [Gradual Progress]', '54. The Marrying Maiden',
                       '55. Abundance [Fullness]', '56. The Wanderer', '57. The Gentle [The Penetrating]',
...
tkinter.Label(master=window_frame, text='Insert new active path:', font='Georgia 10',
              bg=main_colour).place(relx=0.1, rely=0.75)
# Path Entry
entry_path = StringVar()
path_entry = tkinter.Entry(master=window_frame, width=34, border=2, font='Georgia 10', textvariable=entry_path)
path_entry.place(relx=0.1, rely=0.785)
# Path Save Button
path_save = tkinter.Button(master=window_frame, text='Save', border=3, cursor='hand2', font='Georgia 8 bold',
                           bg=save_colour, activebackground=save_bg_colour,
...
if len(path) < 1:
    tkinter.Label(master=active_path_frame, text='         ---- Warning: No Active Path Found! ----',
                  fg=warning_text_colour, font='Georgia 10', bg=main_colour).grid(row=0, column=0)
else:
...
if len(path) < 1:
    ...
    intro_frame = tk.Frame(master=intro_window, width=450, height=300, bg=intro_colour)
    intro_frame.place(relx=0, rely=0)
    intro_window.geometry('450x300+735+350')
    intro_window.place_slaves()
    tkinter.LabelFrame(intro_frame, width=360, height=220, text='How to get started',
                       font='Georgia 10 bold', fg='yellow', bg=intro_colour).place(relx=0.1, rely=0.05)
    tkinter.Label(intro_frame, text="Step 1:  Setting up the active path\n"
                                    "(Only needs to be done once)\n\n"
                                    "Step 2:  Type in your name\n\n"
                                    "Step 3:  Type in your question\n\n"
                                    "Step 4:  Press Ask\n"
                                    "(if auto method is chosen)\n\n"
                                    "For help or info press the icons.",
                  bg=intro_colour, fg='white', font='Georgia 10', justify=LEFT).place(relx=0.16, rely=0.135)
    tkinter.Button(intro_frame, text='Close Window', font='Georgia 10',
                   command=intro_window.destroy).place(relx=0.675, rely=0.835)
