...
1. The Creative\t\t\t\t\t--\t999999
2. The Receptive\t\t\t\t\t--\t666666
3. Difficulty at the Beginning\t\t\t\t\t--\t966696
4. Youthful Folly\t\t\t\t\t--\t696669
5. Waiting (Nourishment)\t\t\t\t\t--\t999696
6. Conflict\t\t\t\t\t--\t696999
7. The Army\t\t\t\t\t--\t696666
8. Holding Together [union]\t\t\t\t\t--\t666696
9. The Taming Power of the Small\t\t\t\t\t--\t999699
10. Treading [conduct]\t\t\t\t\t--\t996999
11. Peace\t\t\t\t\t--\t999666
12. Standstill [Stagnation]\t\t\t\t\t--\t666999
13. Fellowship with Men\t\t\t\t\t--\t969999
14. Possession in Great Measure\t\t\t\t\t--\t999969
15. Modesty\t\t\t\t\t--\t669666
16. Enthusiasm\t\t\t\t\t--\t666966
17. Following\t\t\t\t\t--\t966996
18. Work on what has been spoiled [ Decay ]\t\t\t\t\t--\t699669
19. Approach\t\t\t\t\t--\t996666
20. Contemplation (View)\t\t\t\t\t--\t666699
21. SBiting Through\t\t\t\t\t--\t966969
22. Grace\t\t\t\t\t--\t969669
23. Splitting Apart\t\t\t\t\t--\t666669
24. Return (The Turning Point)\t\t\t\t\t--\t966666
25. Innocence (The Unexpected)\t\t\t\t\t--\t966999
26. The Taming Power of the Great\t\t\t\t\t--\t999669
27. Comers of the Mouth (Providing Nourishment)\t\t\t\t\t--\t966669
28. Preponderance of the Great\t\t\t\t\t--\t699996
29. The Abysmal (Water)\t\t\t\t\t--\t696696
30. The Clinging, Fire\t\t\t\t\t--\t969969
31. Influence (Wooing)\t\t\t\t\t--\t669996
32. Duration\t\t\t\t\t--\t699966
33. Retreat\t\t\t\t\t--\t669999
34. The Power of the Great\t\t\t\t\t--\t999966
35. Progress\t\t\t\t\t--\t666969
36. Darkening of the light\t\t\t\t\t--\t969666
37. The Family [The Clan]\t\t\t\t\t--\t969699
38. Opposition\t\t\t\t\t--\t996969
39. Obstruction\t\t\t\t\t--\t669696
40. Deliverance\t\t\t\t\t--\t696966
41. Decrease\t\t\t\t\t--\t996669
42. Increase\t\t\t\t\t--\t966699
43. Break-through (Resoluteness)\t\t\t\t\t--\t999996
44. Coming to Meet\t\t\t\t\t--\t699999
45. Gathering Together [Massing]\t\t\t\t\t--\t666996
46. Pushing Upward\t\t\t\t\t--\t699666
47. Oppression (Exhaustion)\t\t\t\t\t--\t696996
48. The Well\t\t\t\t\t--\t699696
49. Revolution (Molting)\t\t\t\t\t--\t969996
50. The Caldron\t\t\t\t\t--\t699969
51. The Arousing (Shock, Thunder)\t\t\t\t\t--\t966966
52. Keeping Still, Mountain\t\t\t\t\t--\t669669
53. Development (Gradual Progress)\t\t\t\t\t--\t669699
54. The Marrying Maiden\t\t\t\t\t--\t996966
55. Abundance [Fullness]\t\t\t\t\t--\t969966
56. The Wanderer\t\t\t\t\t--\t669969
57. The Gentle (The Penetrating, Wind)\t\t\t\t\t--\t699699
58. The Joyous, Lake\t\t\t\t\t--\t996996
59. Dispersion [Dissolution]\t\t\t\t\t--\t696699
60. Limitation\t\t\t\t\t--\t996696
61. Inner Truth\t\t\t\t\t--\t996699
62. Preponderance of the Small\t\t\t\t\t--\t669966
63. After Completion\t\t\t\t\t--\t969696
64. Before Completion\t\t\t\t\t--\t696969
"""],
...
hexagram is a number series 'code' comprised of 6's and/or 9's, and below the
index you will find the actual book from beginning to end. If you want to read one
specific hexagram you can either scroll down and find it or use the manuel
method and the code entry.

But you can of cause modify the code to show you whatever sequence of hexagrams
and lines you please. Suppose you wish to look at 3. Difficulty at the Beginning
but are only interested in line 3 and 5, and the hexagram it changes into, then all
you have to do is to modify the code from 966696 to 786898. In other word leave the
6's and 9's unaltered in the positions of the lines you wish to view."""],
                   'Foreword': ["""Foreword:
...
In the spirit of Carl G. Jung  will do the same in regard to this digital adaptation
...
one learns something about oneself. How can that be a mistake? I will use the closing
paragraph of Carl G. Jung's foreword in Richard Wilhelm's translation to end my own:   
...
ask how to proceed from there. Also try to be concise and to the point. Long
and convoluted questions makes interpretations near impossible.  
...
def auto_manuel_choice():
    ...
    if auto_manuel.get() is 1:
        ...
        choice_frame_new.place(relx=0.11, rely=0.55)
        ...
        execute_new1 = tkinter.Button(master=window_frame, text='  Ask  ', border=3, height=2, bg=auto_colour,
                                      ...
                                      command=ask_auto)
        execute_new1.place(relx=0.75, rely=0.79)
        ...
        execute_new2 = tkinter.Button(master=window_frame, text='  Ask  ', border=3, height=2, bg=manuel_colour,
                                      activebackground=save_bg_colour, cursor='hand2', font='Georgia 14', fg='white',
                                      command=ask_manuel)
        execute_new2.place(relx=0.75, rely=0.79)
...
tkinter.Button(master=window_frame, image=exclamation_logo, border=3, cursor='hand2', font='Georgia 8 bold',
               bg=info_colour, activebackground=the_book_colour, command=general_info).place(relx=0.955, rely=0.015)
...
tkinter.Label(master=window_frame, text='Insert your question:', font='Georgia 10',
              bg=main_colour).place(relx=0.1, rely=0.165)
# Question Entry
question_entry_scroll = tk.Scrollbar(window_frame)
question_entry = tk.Text(master=window_frame, width=47, height=7, borderwidth=4, font='Georgia 14', wrap=tk.WORD)
question_entry_scroll.place(relx=0.815, rely=0.2, height=171)
question_entry.place(relx=0.1, rely=0.2)
...
tkinter.Button(master=window_frame, image=question_logo_1, border=3, cursor='hand2', font='Georgia 8 bold',
               bg=info_colour, activebackground=info_bg_colour, command=question_help).place(relx=0.855, rely=0.2)


# Choose Method Frame
tkinter.Label(master=window_frame, text='Choose Method', font='Georgia 10',
              bg=main_colour).place(relx=0.105, rely=0.515)
choice_frame = tkinter.LabelFrame(master=window_frame, font='Georgia 10', bg=auto_colour)
choice_frame.place(relx=0.11, rely=0.55)
# Choose Method Radiobutton
auto_manuel = tkinter.IntVar()
auto_manuel.set(1)
# Auto
auto = tkinter.Radiobutton(choice_frame, text='Auto', font='Georgia', value=1, bg=auto_colour, cursor='hand2',
...
# Manuel
manuel = tkinter.Radiobutton(choice_frame, text='Manuel', font='Georgia', value=2, bg=auto_colour, cursor='hand2',
                             variable=auto_manuel, activebackground=auto_colour, command=auto_manuel_choice)
...
tkinter.Label(master=window_frame, text='Manuel Coin Toss', font='Georgia 10',
              bg=main_colour).place(relx=0.26, rely=0.515)
manuel_toss = tkinter.LabelFrame(master=window_frame, bg=manuel_colour)
manuel_toss.place(width=450, height=74, relx=0.26, rely=0.55)
# Coin Toss Spinbox 1
...
line_one = tkinter.Spinbox(manuel_toss, width=2, from_=6, to=9, font='Times 16', borderwidth=2, justify=CENTER,
                           textvariable=line_1, state=NORMAL, command=update)
...
line_two = tkinter.Spinbox(manuel_toss, width=2, from_=6, to=9, font='Times 16', borderwidth=2, justify=CENTER,
                           textvariable=line_2, state=NORMAL, command=update)
...
line_three = tkinter.Spinbox(manuel_toss, width=2, from_=6, to=9, font='Times 16', borderwidth=2, justify=CENTER,
                             textvariable=line_3, state=NORMAL, command=update)
...
line_four = tkinter.Spinbox(manuel_toss, width=2, from_=6, to=9, font='Times 16', borderwidth=2, justify=CENTER,
                            textvariable=line_4, state=NORMAL, command=update)
...
line_five = tkinter.Spinbox(manuel_toss, width=2, from_=6, to=9, font='Times 16', borderwidth=2, justify=CENTER,
                            textvariable=line_5, state=NORMAL, command=update)
...
line_six = tkinter.Spinbox(manuel_toss, width=2, from_=6, to=9, font='Times 16', borderwidth=2, justify=CENTER,
                           textvariable=line_6, state=NORMAL, command=update)
...
tkinter.Button(master=window_frame, image=question_logo_2, border=3, cursor='hand2', font='Georgia 8 bold',
               bg=info_colour, activebackground=info_bg_colour, command=manuel_help).place(relx=0.835, rely=0.55)
...
execute = tkinter.Button(master=window_frame, text='  Ask  ', height=2, border=3, bg=auto_colour,
                         activebackground=save_bg_colour, cursor='hand2', font='Georgia 14', fg='white',
                         command=ask_auto)
execute.place(relx=0.75, rely=0.79)


# Current Version Label
tkinter.Label(master=window_frame, text='Version: 1.1', font='Georgia 7',
...
if len(path) < 1:
    ...
    tkinter.LabelFrame(intro_frame, width=360, height=220, text='How to get started',
                       font='Georgia 10 bold', fg=warning_text_colour, bg=intro_colour).place(relx=0.1, rely=0.05)
